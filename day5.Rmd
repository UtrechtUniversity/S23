...
## 5.1 Exercise 1: Random Intercept Model with Implicit Lagged Effects (not DSEM)
...
### 5.1.b Model Equations & Parameters
...
## 5.2 Exercise 2: Random Intercept and Slopes Model with Implicit Lagged Effects (not DSEM)
...
## 5.3 Exercise 3: Dynamic SEM - including random autoregressive effects.
...
### 5.3.c Convergence & Interpret the Results
...
## 5.4 Exercise 4: Dynamic SEM - including random autoregressive and cross-lagged effects.
...
### 5.4.c Convergence & Interpret the Results
...
## 5.5 Bonus Exercise 5: Dynamic SEM - adding an implicit lag 2 effect.
...
### 5.5.b Run the Mplus Model & Interpret the Results
...
## 5.6 Bonus Exercise 6: Dynamic SEM - adding a between level factor structure.
...
### 5.6.b Convergence & Interpret the Results
...
## 5.7 Bonus Exercise 7: Dynamic SEM - making the residual variance person-specific.
...
## 5.8 Bonus Exercise 8: Dynamic SEM - Adding a level 2 (between level) predictor.
