...
[This video](https://video.uu.nl/videos/mplus-tutorial-solisworkspace/) explains how you can start up Mplus using SolisWorkspace (SWS), and access files on your local computer. In case you run into IT-related issues, we have listed some useful resources below.
