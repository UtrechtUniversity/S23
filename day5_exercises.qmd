...
Furthermore, people with a high within-person slope b1 (copmared to the average within-person slope), have a low mean on somber (while keeping the score average event constant).
:::
...
MODEL:
            %WITHIN%
            b1 | somber ON event; ! random regression
            b2 | somber ON somber&1; ! random autoregression 
            
            %BETWEEN%
            somber ON event b1 b2;
            event b1 b2 WITH b1 b2;
```
...
::: {.callout-caution collapse="true"}
#### Answer
![](figures/BetweenHist3.jpg){width="700px"}
...
### Convergence & Interpret the Results
If you do not find signs of non-convergence, you can proceed with checking the parameter estimates. Which factor loadings are significant, and what do they mean?
