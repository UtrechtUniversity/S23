...
If you are working in R with the lavaan-package, you can find more information about the $\bar{\chi}^{2}$-test at [jeroendmulder.github.io/RI-CLPM/lavaan.html#(bar{chi}\^{2})-test](https://jeroendmulder.github.io/RI-CLPM/lavaan.html#(bar%7Bchi%7D%5E%7B2%7D)-test). For Mplus users, there is a [Shiny app by Rebecca Kuiper](https://www.uu.nl/staff/RMKuiper/Websites%20%2F%20Shiny%20apps) available as well.
:::
