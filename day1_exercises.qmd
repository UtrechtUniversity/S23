...
``` default
ANALYSIS: 
  BOOTSTRAP = 1000; ! Gives bootstrapped point estimates, standard errors and p-values

OUTPUT:   
  CINTERVAL(BOOTSTRAP); ! Gives confidence intervals based on bootstrap (i.e., it can be asymmetric)
```
